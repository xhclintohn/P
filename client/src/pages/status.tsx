    ...
    <div className="min-h-screen pt-16">
      <div className="container mx-auto max-w-7xl px-4 py-8">
        ...
        <div className="flex items-start justify-between gap-4 mb-8 flex-wrap">
          <div>
            <h1 className="text-3xl md:text-4xl font-bold text-foreground mb-2" data-testid="text-status-title">
              System Status
            </h1>
        ...
        <Card className="p-6 md:p-8 mb-8" data-testid="card-overall-status">
          <div className="flex items-center gap-4 mb-6">
            <StatusDot
              isOnline={overallHealthy}
              size="lg"
            />
            <div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            <div className="text-center p-4 rounded-md bg-card">
        ...
        <Card className="p-6 md:p-8 mb-8" data-testid="card-visitor-stats">
        ...
        <div className="space-y-6">
          {apiCategories.map((category, catIndex) => {
            ...
            return (
              <Card key={category.name} className="overflow-hidden" data-testid={`card-status-${category.name.toLowerCase()}`}>
